...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="user-dash text-center">
            ...
            <table>
                <thead>
                    <tr style="font-size: 1rem;">
                        ...
                        <th>Name</th>
                        <th>Email</th>
                        <th style="padding: 0.6rem;">Country</th>
                        <th colspan="2" style="padding: 0.8rem">Operation</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    while ($res = mysqli_fetch_array($query)) {
                        ...
                        <td><a href="useredit.php?id=<?php echo $res['id']; ?>" data-toggle="tooltip" data-placement="top" title="edit">Edit<i class='fas fa-edit'></i></a></td>
                        <td><a href="delete.php?id=<?php echo $res['id']; ?>" data-toggle="tooltip" data-placement="top" title="delete">Delete<i class="fa-solid fa-trash"></i></a></td>
                    </tr>
