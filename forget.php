<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $email_ser="select * from tbl_users where email='$email'";
        ...
        if($email_cou){
          ...
          $body = "Hi, $name. Click here to reset your password
           http:/localhost/fun/forget.php?token=$token ";

           $sender_email = "From: karkisujan655@gmail.com";
  ...
  <nav class="navbar navbar-expand-lg bg-light">
    ...
    <div class="container">
        ...
        <form action method='POST'>
           ...
           <label for="">Email: </label> <input type="text" name="email" value="" placeholder="enter your email">  <br>   <br>
